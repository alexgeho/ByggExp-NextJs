...
export default class ContentBlocks extends Component {
    render() {
        return (
            ...
            <div className="d-flex justify-content-center align-items-center PricingSection">

                <Row>

                    <Col sm={12} xl={6} style={{marginBottom: '20px'}} className="d-flex flex-column ps-4 mt-2">
