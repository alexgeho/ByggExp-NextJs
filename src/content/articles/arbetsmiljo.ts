...
<p>Det centrala kravet är att riskbedömningen alltid ska <strong>dokumenteras skriftligt</strong>. Dokumentationen ska visa vilka riskerna är och om de är allvarliga. På bygg- och anläggningsprojekt gäller dessutom AFS 2023:3, som reglerar ansvaret för byggherre, projektörer och de två samordnarrollerna Bas-P (planering och projektering) och Bas-U (utförandet). Skyddsronden är alltså inte en formalitet – den är själva beviset på att ni undersöker och åtgärdar arbetsmiljön löpande.</p><figure class="article-diagram"><img src="/landing/diagrams/skyddsrond-bygg-checklista.webp" alt="Diagram som visar de tre delarna i ett skyddsrondsprotokoll: bristen, ansvarig person samt åtgärd och deadline, vilka bildar en handlingsplan som undertecknas av arbetsgivarrepresentant och skyddsombud." width="720" height="380" loading="lazy"><figcaption>Varje observation på skyddsronden kopplas till tre delar – brist, ansvarig och åtgärd med deadline – som tillsammans bildar den undertecknade handlingsplanen.</figcaption></figure>
...
<p>Vill du komma igång direkt kan du använda <a href="/sv/verktyg/arbetsberedning-mall">vår gratis arbetsberedning-mall →</a> – fyll i momentet, riskerna och åtgärderna och ladda ner den som PDF.</p><figure class="article-diagram"><img src="/landing/diagrams/arbetsberedning-mall-bygg.webp" alt="Diagram över de åtta delarna i en komplett arbetsberedning: moment och omfattning, metod steg för steg, resurser, APD-plan och etablering, risk per steg med åtgärd, behörighet och kompetens, kontroll och kvalitetskrav samt kommunikation." width="720" height="380" loading="lazy"><figcaption>De åtta delar som en fullständig arbetsberedning normalt dokumenterar, från moment och metod till risk per steg och kommunikation.</figcaption></figure>
...
<h2>Kom igång</h2>
<p>Börja med att fylla i <a href="/sv/verktyg/arbetsberedning-mall">vår kostnadsfria arbetsberedning-mall</a>, eller bläddra bland fler <a href="/sv/verktyg">gratis verktyg för byggföretag</a>. Vill du se hur beredning, egenkontroll och projektdokumentation hänger ihop i ett flöde? <a href="/sv/contact">Boka en demo →</a></p>
