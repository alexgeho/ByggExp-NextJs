...
// help take the calculation further (offert, material, next steps). Posts to the
// same demo-request endpoint the contact form uses; `tool` and `summary` ride
// along as extra fields so sales sees which calculator the lead came from.
  ...
  return (
    <div className="lm-tool lm-leadform">
      <div className="lm-tool-head">
        ...
        <p className="lm-tool-sub">
          Lämna dina uppgifter så hjälper vi dig med offert, material och nästa
          steg – utan kostnad.
        </p>
      </div>
        ...
        <div className="lm-tool-actions" style={{ marginTop: 14 }}>
          ...
          {status === 'error' ? (
            <span className="lm-result-fine" style={{ color: '#d64545' }}>
              Något gick fel – försök igen eller mejla support@byggexp.se.
            </span>
          ) : null}
        </div>
