...
const CONTENT: Record<Locale, ToolContent> = {
  ...
  nb: {
    ...
    sections: [
      ...
      { id: 'cc-avstand', heading: 'Hvilken c/c-avstand skal takstolene ha?', body: (<><p>Senteravstanden (c/c) avhenger av taktekking, undertak og snølast. Standard er 1200 mm for prefabrikkerte takstoler – også for betong- og teglpanner, fordi takstolene da dimensjoneres for tungt tak. Tettere c/c (600 eller 900 mm) forekommer i noen tilfeller, men det avgjør produsenten. Bruk alltid c/c-avstanden på takstoltegningen.</p></>) },
  ...
  en: {
    ...
    sections: [
      ...
      { id: 'cc-avstand', heading: 'Which c/c spacing should the trusses have?', body: (<><p>The spacing (c/c) depends on the roof covering, sub-roof and snow load. The standard is 1200 mm for prefabricated trusses – also for concrete and clay tiles, since the trusses are then designed for a heavy roof. Closer c/c (600 or 900 mm) occurs in some cases, but the manufacturer decides. Always use the c/c on the truss drawing.</p></>) },
