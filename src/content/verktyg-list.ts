...
export const VERKTYG_GROUPS: VerktygGroup[] = [
  {
    ...
    items: [
      ...
      { slug: 'restidsersattning-kalkylator', label: 'Restids- & reseersättning' },
      { slug: 'ackord-kalkylator', label: 'Ackord (ackordsöverskott)' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'egenkontroll-ventilation-mall', label: 'Egenkontroll ventilation-mall' },
      { slug: 'egenkontroll-vatrum-mall', label: 'Egenkontroll våtrum-mall' },
      { slug: 'egenkontroll-tak-mall', label: 'Egenkontroll tak-mall' },
