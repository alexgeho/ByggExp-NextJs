// AUTO-GENERATED: slugs whose blog cover is a real generated photo at
// /landing/blog/<slug>.webp (via scripts/gen-image.js). These take precedence over
// the text-card manifest and must never be regenerated as text cards.
export const PHOTO_COVER_SLUGS = new Set<string>([
