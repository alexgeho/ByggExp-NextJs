...
// Standalone public legal document shell for byggexp.se — mirrors the same
// pages in the admin app (admin.byggexp.se/legal/*). Self-contained styling via
// styled-jsx (namespaced under .legal-page) so it needs no global stylesheet.
