...
const CONTENT: Record<Locale, ToolContent> = {
  sv: {
    metaTitle: 'Gipsskivor – antal & mått, hela materiallistan (gratis) | ByggExp',
    description:
      'Gipsskivor per vägg: fyll i måtten så räknar vi hela materiallistan – antal gipsskivor, reglar (rätt c/c), skruv och isolering, enkel- eller dubbelsidig. Gratis, utan konto.',
