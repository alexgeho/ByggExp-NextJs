...
<p>Varje år förlorar byggföretag pengar på arbeten de faktiskt utfört – inte för att jobbet var dåligt, utan för att avtalet var svagt eller muntligt. När beställaren bestrider en faktura eller påstår att något var fel är det avtalstexten som avgör, inte vad ni kom överens om över telefon. Ett muntligt avtal är giltigt, men i praktiken näst intill omöjligt att bevisa. Den här guiden går igenom vad ett entreprenadkontrakt måste innehålla för att hålla vid tvist – och ger dig en <strong>entreprenadkontrakt mall gratis</strong> som du kan fylla i och skicka samma dag. (Kärt barn har många namn – entreprenadkontrakt, entreprenadavtal och byggkontrakt syftar på samma sak: det skriftliga avtalet mellan dig och beställaren. Förväxla det inte med <em>Byggavtalet</em>, som är kollektivavtalet mellan Byggföretagen och Byggnads om löner och villkor.)</p><figure class="article-diagram"><img src="/landing/diagrams/entreprenadkontrakt-mall.webp" alt="Tidslinje som visar frister i AB 04 och ABT 06 räknat från godkänd slutbesiktning: 2 års garanti på material, 5 års garanti på arbetsprestation och 10 års ansvarstid." width="720" height="380" loading="lazy"><figcaption>Så förhåller sig garantitiden och ansvarstiden i AB 04 och ABT 06 till varandra, räknat från godkänd slutbesiktning.</figcaption></figure>
...
<p>Vill du snabbt räkna ut ett tillägg? Använd vår gratis <a href="/sv/verktyg/ob-overtid-kalkylator">OB- och övertidskalkylator</a> – fyll i timlön och nivå så får du tillägget direkt. Vill du logga arbetad tid, OB och övertid direkt på arbetsplatsen? Testa vår gratis <a href="/sv/verktyg/tidrapport-mall">tidrapport-mall</a>.</p><figure class="article-diagram"><img src="/landing/diagrams/ob-overtid-byggavtalet-rakna.webp" alt="Tabell över OB-satser (20, 40, 70 procent) och övertidssatser (30, 50, 70, 100 procent) i Byggavtalet, med regeln att de aldrig betalas samtidigt." width="720" height="380" loading="lazy"><figcaption>OB-tilläggets tre nivåer och övertidens fyra nivåer i Byggavtalet – båda i procent på utgående lön och aldrig samtidigt.</figcaption></figure>
...
<p>Som general- eller totalentreprenör sitter du med hela risken mot din beställare – tider, viten, garantitider och besiktning. Ändå glömmer många att föra ner exakt samma villkor till sina underentreprenörer. Blir din UE försenad, men du inte har speglat vitesbestämmelsen nedåt, fastnar kostnaden hos dig. Standardavtalen för <strong>AB-U ABT-U underentreprenör avtal</strong> är byggda just för att lösa detta: de speglar (back-to-back) huvudavtalet så att risken vandrar vidare i entreprenadkedjan i stället för att stanna på ditt bord.</p><figure class="article-diagram"><img src="/landing/diagrams/ab-u-underentreprenor-avtal.webp" alt="Tabell över de viktigaste speglingsklausulerna i AB-U 07 med punktnummer och värden: garantitid, förseningsvite 1 procent lägst 5 000 kr per vecka, säkerhet 10 procent, besiktning 2 månader, preskription 4/22/8 månader och namnbricka-vite 500 kr per person och dag." width="720" height="380" loading="lazy"><figcaption>De centrala back-to-back-klausulerna i AB-U 07 med punktnummer och de faktiska värdena du ska matcha mot ditt huvudavtal.</figcaption></figure>
