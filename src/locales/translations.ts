export const translations = {
  ...
  en: {
    ...
    whyItem4:
      "Office staff spend dozens of hours on manual Excel data entry",

    whyResult: "As a result:",
    whyResultText:
