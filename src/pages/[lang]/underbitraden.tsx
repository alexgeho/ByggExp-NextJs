  ...
  return (
    <LegalDocument title="Underbiträden" updated="2026-07-30">
      <p>
        ...
        tillhandahålla ByggExp. Överföring till tredje land sker endast med giltig
        mekanism (EU:s standardavtalsklausuler och/eller EU-US Data Privacy
        Framework).
      </p>
      <table>
        <thead>
      ...
      <p>
        ...
        uppdaterar listan när underbiträden tillkommer eller tas bort och informerar
        personuppgiftsansvariga kunder enligt personuppgiftsbiträdesavtalet.
      </p>
      <h2>Kontakt</h2>
