  ...
  return (
    ...
    >
      <p className="legal-page__note">
        ...
        jurist innan undertecknande.
      </p>

      <p>
        RealMar AB (org.nr 559474-9383), ”Biträdet”, behandlar personuppgifter för
        kundföretagets (”Ansvarig”) räkning enligt art. 28 GDPR.
      </p>

      <h2>1. Föremål och varaktighet</h2>
      <p>
        Biträdet behandlar uppgifter endast för att tillhandahålla plattformen, så
        länge huvudavtalet gäller. Vid upphörande raderas eller återlämnas uppgifter
        enligt punkt 8.
      </p>

      <h2>2. Behandlingens art och ändamål</h2>
      <p>
        Drift av bygg-/projekthanteringsplattform: konton, projekt, uppgifter, tid-
        och närvaroregistrering, GPS vid arbetspass, fakturering, lön och
        dokumenthantering.
      </p>
      ...
      <p>
        ...
        Identitet/kontakt, anställningsdata, personnummer (ROT/lön), tid/närvaro,
        platsdata (GPS), ekonomi och projektdata.
      </p>

      <h2>4. Biträdets skyldigheter</h2>
      <p>
        Behandla endast enligt Ansvarigs dokumenterade instruktioner; säkerställa
        tystnadsplikt; vidta säkerhetsåtgärder enligt art. 32; bistå med
        registrerades rättigheter, säkerhet, incidentanmälan och DPIA;
        radera/återlämna vid avslut; möjliggöra granskning.
      </p>
