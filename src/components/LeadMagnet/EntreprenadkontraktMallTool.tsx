...
const CONFIG: MallConfig = {
  ...
  example: {
    ...
    standard: 'AB 04 (utförandeentreprenad)',
    scope: 'Totalrenovering av badrum ca 6 m²: rivning, tätskikt enligt BBV, kakel/klinker, VVS och el.',
    exclusions: 'Badrumsmöbel och blandare tillhandahålls av beställaren. Målning av angränsande rum ingår ej.',
    ...
    warranty: 'Garantitid enligt AB 04: 5 år för arbetet, 2 år för material och varor. Ansvarstid 10 år från godkänd slutbesiktning.',
