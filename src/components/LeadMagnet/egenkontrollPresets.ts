...
export const EGENKONTROLL_PRESETS: EgenkontrollPreset[] = [
  {
    ...
    items: [
      ...
      { section: 'B. Okulär kontroll', point: 'Genomföringar brandtätade där ledningar passerar brandcellsgräns', reference: 'BFS 2024:7' },
  ...
  },
  {
    ...
    items: [
      ...
      { section: 'B. Provning', point: 'Tappvarmvattentemperatur vid tappställe', method: 'Mätning', unit: '°C', requirement: '≥ 50 °C', reference: 'BFS 2024:8' },
  ...
  },
  {
    ...
    items: [
      ...
      { section: 'B. Utförande', point: 'Brandtätning av genomföringar i brandcellsgräns', method: 'Okulär', requirement: 'Brandskyddsdokumentation', reference: 'BFS 2024:7' },
  ...
  },
  {
    ...
    items: [
      ...
      { section: 'B. Tätskikt', point: 'Genomföringar och rörgenomföringar täta', method: 'Okulär', requirement: 'Branschregler', reference: 'BFS 2024:8' },
  ...
  },
  {
    ...
    items: [
      ...
      { section: 'E. Taksäkerhet', point: 'Taksäkerhet (snörasskydd, fästen) monterad', method: 'Okulär', requirement: 'Tillverkarens anvisning', reference: 'BFS 2024:9' },
      { section: 'E. Taksäkerhet', point: 'Takstege och glidskydd för underhåll monterade där det krävs', method: 'Okulär', requirement: 'Handlingar', reference: 'BFS 2024:9' },
  ...
  },
  {
    ...
    items: [
      ...
      { section: 'A. Montage', point: 'Brandspjäll och brandisolering vid brandcellsgräns', method: 'Okulär', requirement: 'Brandskyddsdokumentation', reference: 'BFS 2024:7' },
      { section: 'A. Montage', point: 'Rensluckor åtkomliga, don och aggregat märkta', method: 'Okulär', requirement: 'Handlingar' },
      { section: 'B. Provning och injustering', point: 'Brandspjäll funktionstestade', method: 'Funktionsprov', requirement: 'Brandskyddsdokumentation', reference: 'BFS 2024:7' },
