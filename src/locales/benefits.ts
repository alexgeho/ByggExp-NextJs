export const benefitsTranslations = {
  ...
  uk: {
    office: {
      benefitsOfficeTitle: "Що ви отримаєте, працюючи з нами?",
    ...
    office: {
      benefitsOfficeTitle: "Mitä hyödyt yhteistyöstä kanssamme?",
  ...
  et: {
    office: {
      benefitsOfficeTitle: "Mida võidate meiega koostööst?",
  ...
  lt: {
    office: {
      benefitsOfficeTitle: "Ką laimėsite dirbdami su mumis?",
  ...
  lv: {
    office: {
      benefitsOfficeTitle: "Ko iegūsiet, strādājot ar mums?",
