  ...
  return (
    <LegalDocument title="Integritetspolicy" updated="2026-07-30">
      <p>
        ...
        behandlar personuppgifter i ByggExp-plattformen. För anställdas uppgifter
        agerar vi normalt personuppgiftsbiträde åt kundföretaget (arbetsgivaren),
      ...
      <ul>
        ...
        <li>
          Tid &amp; närvaro: arbetspass, in-/utcheckning, timmar, personalliggare.
        </li>
        <li>Platsdata (GPS): position vid arbetspass för att styrka arbetad tid.</li>
        <li>
          Projekt: uppgifter, dagbok, foton, dokument. Ekonomi: fakturor, utlägg,
          lön.
        </li>
      </ul>
      ...
      <h2>Lagringstider</h2>
      <p>
        GPS-positioner raderas automatiskt efter 90 dagar. Personalliggare sparas i
        minst 2 år, bokföring/fakturor i 7 år. Övriga uppgifter så länge
        kund-/anställnings­relationen består, därefter gallring.
      </p>

      <h2>Mottagare och överföringar</h2>
      <p>
        Vi anlitar underbiträden för drift, betalning, e-post och AI-funktioner.
        Överföring till tredje land sker endast med giltig mekanism (EU:s
        standardavtalsklausuler / EU-US Data Privacy Framework).
      </p>
